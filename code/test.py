...
parser.add_argument("--save_path", type=str, default="/home/r/works/derain_arxiv/release/results/ANRN", help='path to save results')
...
def main():
    ...
    # Build model
    print('Loading model ...\n')
    model = ANRN(opt.recurrent_iter, opt.use_GPU)
    print_network(model)
    if opt.use_GPU:
        model = model.cuda()
